...
function genOtherVocab(lang,count,sampleSize){
  const samples={
    ...
    fr:[
      ...
      ['personne','人','A1'],['ami','朋友','A1'],['famille','家庭','A1école','学校','A1'],
      ['entreprise','企业','A2'],['français','法语','A1'],['anglais','英语','A1'],
    ],
    es:[
      ...
      ['persona','人','A1'],['amigo','朋友','A1'],['familia','家庭','A1escuela','学校','A1'],
    ...
    de:[
      ...
      ['Person','人','A1']['Freund','朋友','A1']['Familie','家庭','A1Schule','学校','A1'],
