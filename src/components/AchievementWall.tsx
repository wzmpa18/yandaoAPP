...
const ALL_ACHIEVEMENTS = [
  ...
  { key: 'multilingual',   icon: '🌍', name: '多语先锋',   desc: '更换过目标语言',            threshold: () => false },
  { key: 'game_master',    icon: '🎮', name: '游戏大师',   desc: '玩过所有7种游戏',           threshold: () => false },
  { key: 'social_butterfly',icon: '🤝',name: '社交达人',   desc: '添加了第一个好友',          threshold: () => false },
